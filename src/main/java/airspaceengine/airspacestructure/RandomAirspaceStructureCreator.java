...
class RandomAirspaceStructureCreator implements AirspaceStructureCreator {
    ...
    public AirspaceStructure createAirspaceStructure(){
        ...
        nodes.add(new Waypoint( "WP_00001", true,100,  100, 1));
        nodes.add(new Waypoint("WP_00002", true, 240,  400, 1));
        nodes.add(new Waypoint("WP_00003", true,300, 300, 1));
        nodes.add(new Waypoint("WP_00004", true,450, 200, 1));
        nodes.add(new Waypoint("WP_00005", true,500, 500, 1));
        nodes.add(new Waypoint("WP_00006", true,550, 250, 1));
